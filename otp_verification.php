...
if (isset($_POST['send_otp'])) {
    ...
    $query = $conn->prepare("SELECT * FROM voters WHERE email = ? AND firstname = ?");
    ...
    if ($user) {
        ...
        $updateQuery = $conn->prepare("UPDATE voters SET otp = ?, otp_expiry = ? WHERE email = ?");
...
if (isset($_POST['verify_otp'])) {
    ...
    $query = $conn->prepare("SELECT id, firstname, lastname, otp_expiry FROM voters WHERE email = ? AND firstname = ? AND otp = ?");
    ...
    if ($user) {
        ...
        $clearOtpQuery = $conn->prepare("UPDATE voters SET otp = NULL, otp_expiry = NULL WHERE email = ?");
